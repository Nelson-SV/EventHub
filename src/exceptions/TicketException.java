...
public class TicketException extends Exception {
    ...
    private static final Logger logger = Logger.getLogger("TicketException");
    ...
    public TicketException(String message, Throwable cause, ErrorCode code) {
        super(message, cause);
        this.errorCode = code;
    ...
    public TicketException(ErrorCode code){
        super();
        this.errorCode=code;
